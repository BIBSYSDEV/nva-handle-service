...
class CreateApprovalRequestTest {
  ...
  void shouldThrowIllegalArgumentExceptionWhenCreatingNewApprovalFromRequestWithoutIdentifier() {
    ...
    assertEquals(
        "At least one identifier is mandatory for approval creation", executable.getMessage());
  }
  ...
  private static CreateApprovalRequest randomApprovalRequest(
      List<NamedIdentifier> namedIdentifiers, URI source) {
