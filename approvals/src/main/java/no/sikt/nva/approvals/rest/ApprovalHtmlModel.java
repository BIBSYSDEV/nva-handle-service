...
public record ApprovalHtmlModel(
  ...
  private static Collection<TrialSite> extractTrialSites(
      ClinicalTrial clinicalTrial, String applicationDomain) {
  ...
  private static TrialSite toTrialSite(
      no.sikt.nva.approvals.dmp.model.TrialSite site, String applicationDomain) {
  ...
  public record TrialSite(String departmentName, Investigator investigator) {}

  public record Investigator(
      String profileUrl, String title, String firstname, String lastname, String department) {}
}
